  ...
  return (
    <div className="bg-black/50 w-full h-full fixed top-0 left-0 z-[99] items-center justify-center hidden">
      <div className="bg-white p-5 rounded-md min-w-[90%] md:min-w-[600px]">
              ...
              <input type="text" placeholder="Digite seu endereço completo..." id="adrress" className="w-full border-2 p-1 rounded my-1" />
              ...
              <div className="flex items-center justify-between mt-5 w-full">
                  ...
                  <button id="checkout-btn" className="bg-green-500 text-white px-4 py1 rounded">Finalizar pedido</button>
              </div>
      </div>
    </div>
  );
